...
ticketPriceTotal = runners.reduce((totalValue, runner) => totalValue + runner.donation, 0);
//OR
...
const runFirst = runners.filter (runner => runner.id <= '25')
console.log(runFirst)

// Problem 3
const shirts = runners.map(item => item.shirt_size);
//OR
// const shirts = runners.map(function(item){
